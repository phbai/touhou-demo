...
(function () {
    ...
    t.o = function (a, c) {
        ...
        c = t.Pb(c);
        d.ca && d.ca.call(a, c);
        if (e && !c.Vb() && c.bubbles !== l)t.o(e, c); else if (!e && !c.defaultPrevented && (d = t.getData(c.target), c.target[c.type])) {
            d.disabled = f;
    ...
    s.ja = function (a) {
        if (37 == a.which || 40 == a.which)a.preventDefault(), this.jd(); else if (38 == a.which || 39 == a.which)a.preventDefault(), this.kd()
    };
    s.kb = function () {
    ...
    s.exitFullscreen = function () {
        var a = t.cb.Rb;
        this.isFullscreen(l);
        if (a)document[a.exitFullscreen](); else this.h.Ta() ? N(this, "exitFullScreen") : (this.Nb(), this.o("fullscreenchange"));
        return this
    };
    ...
    s.ee = function () {
        for (var a = this.c.textTracks, c, d = a.length, e = {
            captions: 1,
            subtitles: 1
        }; d--;)if ((c = a[d]) && c.kind in e)c.mode = "disabled"
    };
    s.Wd = function (a) {
    ...
    s.ha = function (a) {
        ...
        c.track.mode = "metadata" === c.U.kind ? "hidden" : "disabled";
        c.onload = function () {
            var a = c.track;
    ...
    t.g = t.j.extend({
        l: function (a, c, d) {
            ...
            var g = this.c = t.e("div", {id: a.id() + "_temp_flash"}), h = a.id() + "_flash_api", k = a.q, k = t.i.D({
                ...
                loop: k.loop,
                muted: k.muted
            }, c.flashVars), p = t.i.D({wmode: "opaque", bgcolor: "#000000"}, c.params), h = t.i.D({
                id: h,
                name: h,
                "class": "vjs-tech"
            }, c.attributes);
    ...
    t.t = function (a) {
        ...
        Object.defineProperty(c, "activeCues", {
            get: function () {
                ...
                A = l;
                if (d.length !== this.Ga.length)A = f; else for (a = 0; a < d.length; a++)-1 === ua.call(this.Ga,
                    d[a]) && (A = f);
                this.Ga = d;
                r.qb(this.Ga);
                return r
    ...
    t.t.prototype.bd = function (a) {
        for (var c = 0, d = this.W.length, e, g = l; c < d; c++)e = this.W[c], e === a && (this.W.splice(c, 1), g = f);
        g && this.Dc.qb(this.W)
    };
    var va, V, ua;
    va = function (a, c) {
    ...
    t.V = function (a) {
        var c = this, d;
        if (t.oa)for (d in c = document.createElement("custom"), t.V.prototype)c[d] = t.V.prototype[d];
        t.V.prototype.qb.call(c, a);
        Object.defineProperty(c, "length", {get: n("pe")});
        if (t.oa)return c
    };
    t.V.prototype.qb = function (a) {
    ...
    t.ra = t.a.extend({
        l: function (a, c, d) {
            ...
            a.I(t.bind(this, function () {
                if (a.h && a.h.featuresNativeTextTracks)this.X(); else {
                    var c, d, h;
    ...
    t.aa = t.M.extend({
        l: function (a, c) {
            var d = this.U = c.track, e = a.textTracks(), g, h;
            e && (g = t.bind(this, function () {
                var a = "showing" === this.U.mode, c, d, g;
                if (this instanceof t.Ab) {
                    a = f;
                    d = 0;
                    for (g = e.length; d < g; d++)if (c = e[d], c.kind === this.U.kind && "showing" === c.mode) {
                        a = l;
                        break
                    }
                }
    ...
    t.aa.prototype.u = function () {
        var a = this.U.kind, c = this.d.textTracks(), d, e = 0;
        t.M.prototype.u.call(this);
        if (c)for (; e < c.length; e++)d = c[e], d.kind === a && (d.mode = d === this.U ? "showing" : "disabled")
    };
    t.Ab = t.aa.extend({
        l: function (a, c) {
    ...
    t.Ya = t.M.extend({
        l: function (a, c) {
            var d = this.U = c.track, e = this.cue = c.cue, g = a.currentTime();
            c.label = e.text;
    ...
    t.V.prototype.getCueById = t.F.prototype.be;
